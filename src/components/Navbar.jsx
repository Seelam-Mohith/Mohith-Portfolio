      ...
      >
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between">
          ...
          <a
            ...
            className="relative flex items-center gap-2 font-display text-2xl tracking-widest text-purple-400"
          >
            <svg viewBox="0 50 130 95" className="w-8 h-8 fill-current text-gray-400" aria-hidden="true">
