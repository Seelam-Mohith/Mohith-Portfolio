    ...
    <div className="group">
      ...
      >
        <div
          ...
          style={{
            background: `rgba(26, 26, 46, ${isHovered ? 0.7 : 0.55})`,
        ...
        >
          ...
          {project.live !== '#' && (
            <span className="absolute top-3 right-3 z-10 flex items-center gap-1.5 px-2.5 py-0.5 rounded-md text-[10px] font-accent font-bold tracking-wider text-white bg-gradient-to-r from-purple-600 to-purple-500 shadow-lg shadow-purple-500/30">
